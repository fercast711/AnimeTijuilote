...
public class Directores extends Personas {
    ...
    public Directores(String Nombre, char Genero, String Primer_Obra, String Ultima_Obra, String Obra_Famosa) {
        super(Nombre, Genero);
    ...
    public void LeerGUI(int i){
        super.LeerGUI(i);
        Primer_Obra = JOptionPane.showInputDialog("Ingrese la primer obra del director #"+(i+1));
        Ultima_Obra = JOptionPane.showInputDialog("Ingrese la ultima obra del director #"+(i+1));
        Obra_Famosa = JOptionPane.showInputDialog("Ingrese la obra mas famosa del director #"+(i+1));
    }
